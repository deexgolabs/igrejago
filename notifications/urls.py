...
from notifications.views import (
    ...
    WhatsAppInstanceConnectView,
    WhatsAppInstanceCreateView,
    WhatsAppInstanceDeleteView,
    WhatsAppInstanceDisconnectView,
    WhatsAppInstanceSetDefaultView,
    WhatsAppInstanceUpdateView,
...
urlpatterns = [
    ...
    path("whatsapp/numeros/novo/", WhatsAppInstanceCreateView.as_view(), name="whatsapp_instance_create"),
    path("whatsapp/numeros/<int:pk>/conectar/", WhatsAppInstanceConnectView.as_view(), name="whatsapp_instance_connect"),
    path(
        "whatsapp/numeros/<int:pk>/desconectar/",
        WhatsAppInstanceDisconnectView.as_view(),
        name="whatsapp_instance_disconnect",
    ),
    path(
        "whatsapp/numeros/<int:pk>/padrao/",
        WhatsAppInstanceSetDefaultView.as_view(),
        name="whatsapp_instance_set_default",
    ),
    path("whatsapp/numeros/<int:pk>/editar/", WhatsAppInstanceUpdateView.as_view(), name="whatsapp_instance_update"),
    path("whatsapp/numeros/<int:pk>/excluir/", WhatsAppInstanceDeleteView.as_view(), name="whatsapp_instance_delete"),
