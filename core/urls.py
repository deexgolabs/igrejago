...
urlpatterns = [
    ...
    path("icone/<int:church_id>/<int:size>.png", church_icon, name="church_icon"),
    ...
    path("relatorio-customizado/exportar.xlsx", CustomReportExportView.as_view(), name="custom_report_export"),
