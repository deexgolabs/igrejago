...
urlpatterns = [
    ...
    path("balanco-patrimonial/", BalancoPatrimonialView.as_view(), name="balanco_patrimonial"),
    path("livro-razao/", LivroRazaoView.as_view(), name="livro_razao"),
    ...
    path("doacoes/<int:pk>/pagar/pagbank/", DonationPagBankStartView.as_view(), name="donation_pagbank_start"),
    ...
    path("doacoes/webhook/pagbank/", PagBankWebhookView.as_view(), name="donation_pagbank_webhook"),
