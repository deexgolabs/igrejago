...
def preencher_church(apps, schema_editor):
    ...
    if igreja is None:
        return
    for nome_model in ("CustomForm", "FormField", "FormResponse", "FormAnswer"):
        Model = apps.get_model("custom_forms", nome_model)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0009_church"),
        ("custom_forms", "0003_customform_notify_staff_emails_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name="customform",
            constraint=models.UniqueConstraint(fields=["church", "slug"], name="unique_customform_slug_per_church"),
        ),
    ]
